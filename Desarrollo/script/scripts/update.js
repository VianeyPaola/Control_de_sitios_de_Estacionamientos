...
function update(id_parking,ocupados){
	...
	var url = "http://localhost/ControldeEstacionamiento/Desarrollo/php/actualiza-estacionamiento.php?id_estacionamiento="+id_parking+"&ocupados="+ocupados;
...
var url1 = "http://localhost/ControldeEstacionamiento/Desarrollo/php/consulta-estacionamiento-id.php?id_estacionamiento="+id_parking;
